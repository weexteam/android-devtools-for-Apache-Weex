...
public class OkHttp35SocketClient extends SocketClient {
    ...
    public OkHttp35SocketClient(DebugServerProxy proxy) {
        super(proxy);
        mInvocationHandler = new OkHttp35SocketClient.WebSocketInvocationHandler();
    }
    ...
    protected void connect(String url) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(url)) {
                ...
                Method createWSMethod = ReflectionUtil.tryGetMethod(
                        mOkHttpClientClazz,
                        "newWebSocket",
                ...
                mWebSocket = ReflectionUtil.tryInvokeMethod(
                        mOkHttpClientClazz,
                        createWSMethod,
                        request,
