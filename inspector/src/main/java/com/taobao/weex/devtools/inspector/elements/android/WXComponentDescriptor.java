...
//        }
    ...
    public HashMap<String, String> getStyles(WXComponent element) {
        ...
        WXDomObject domObject = element.getDomObject();
        if (domObject != null && domObject.style != null) {
            map = new HashMap<>();
            for (Map.Entry<String, Object> entry : domObject.style.entrySet()) {
    ...
    public HashMap<String, String> getAttribute(WXComponent element) {
        ...
        if (domObject != null && domObject.attr != null) {
            map = new HashMap<>();
            for (Map.Entry<String, Object> entry : domObject.attr.entrySet()) {
                if (entry.getValue() != null) {
                    map.put(entry.getKey(), entry.getValue().toString());
                }
